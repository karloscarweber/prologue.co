<style>body{background:#f4e8e9!important;}</style>
<div class="climber-container clearfix">
	<h1 class="climberRed">Climber</h1>
</div>
<div class="grater-container">
	<div class="grater">
		<h3>Climber will help you to track, and show off, Your collected experience in any given subject.</h3>
		<p class="lead"><span class="climberRed">Climber</span> is an app that helps you keep track of how much time You've invested in something from the very beginning. Remember that Myth that it takes 10,000 hours of Practice to become an Expert? Well <span class="climberRed">Climber</span> makes it easy to record your time and post it publicly for everyone to see.</p>
	</div>
	<div class="grater">
		<div>
...
<form action="http://prologue.us7.list-manage.com/subscribe/post?u=566b6a939ab109f0181960a6e&amp;id=569e479dd5" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
